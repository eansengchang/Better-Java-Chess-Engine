...
//        }
    ...
    public static String computerMove() {
        ...
        //actual calculation and making move
    ...
    public static void useBook(String moveHistory) {
        ...
        //finds the correct move from the SAN
        ...
        //finally make the move and update the move history
        bestMove = finalMove;
        Board.moveHistory = Board.moveHistory + bestMove;
        Board.makeMove(bestMove);
    }
...
//                    System.out.println(Board.toSAN(bestMove) + ": " + score * turnMultiplier);
    ...
    public static int searchAllCaptures(int alpha, int beta, int turnMultiplier, int depth) {
        ...
        //filters for capture moves unless theres only 1 legal move
    ...
    public static String getCaptures(String list) {
        //loops through each move and deletes non-capture moves
    ...
    public static String sortMoves(String list, int turnMultiplier) {
        ...
        //parralel array of all the scores
        ...
        //selection sort and moves all the good moves to the start
        ...
        for (int i = 0; i < Math.min(6, list.length() / 6); i++) { //first few moves only
            ...
            //sets the max score to big negative number so it won't be picked again
            score[maxLocation] = -1000000;
            //list A is the best few moves
            newListA += list.substring(maxLocation * 6, maxLocation * 6 + 6);
            //list B is the rest of the moves
