...
public class Board {
    ...
    public static void start(){
        while(!"K".equals(chessBoard[whiteKingPosition / 8][whiteKingPosition % 8])){whiteKingPosition++;} // gets white king location
        while(!"k".equals(chessBoard[blackKingPosition / 8][blackKingPosition % 8])){blackKingPosition++;} // gets black king location
...
//                System.out.println("lost king side white");
    ...
    public static boolean kingSafe(int position){
        ...
        for (int i = -1; i <= 1; i+=2) {
             for (int j = -1; j <= 1; j+=2) {
                 try {
                    while(" ".equals(chessBoard[position / 8 + temp*i][position % 8 + temp*j])){temp++;}
        ...
        for (int i = -1; i <= 1; i+=2) {
            //horizontal moves
            try {
               while(" ".equals(chessBoard[position / 8][position % 8 + temp*i])){temp++;}
            ...
            //vertical moves
            try {
               while(" ".equals(chessBoard[position / 8 + temp*i][position % 8])){temp++;}
